...
import { ProfessionalsController } from '@/presentation/controllers/professionals/professionals.controller';
...
describe('List Professionals (E2E)', () => {
  ...
  describe(`${ProfessionalsController.prototype.listProfessionals.name}`, () => {
